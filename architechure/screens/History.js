...
export function History() {
    return (
        <View>
            ...
            <View style={styles.touchCarrier} >
                <View style={styles.touchText}>
                    <Text style={{ fontSize: 32, fontWeight: 'bold' }} >Jack Robinson</Text>
                    <Text style={{ fontSize: 20, fontWeight: 'bold' }} >09084683822</Text>
                    <Text style={{ fontSize: 20, fontWeight: 'bold' }} >jackrobbie@gmail.com</Text>
                </View>
